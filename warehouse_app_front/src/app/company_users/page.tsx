...
export default function Home(props: Props) {
  ...
  const handleCloseUserDelete = () => setOpenUserDelete(false);
  ...
  async function fetchUsers() {
    ...
    try {
      axios
        .get("https://localhost:7296/api/auth/getCompany", {
          headers: {
  ...
  async function postUser() {
    ...
    try {
      axios
        .post("https://localhost:7296/api/auth/registerForCompany", newUser, {
          headers: {
            Authorization: `Bearer ${jwt}`,
          },
        })
